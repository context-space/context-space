...
func (a *OpenWeatherMapAdapter) registerOperations() {
	...
	a.RegisterOperation(operationIDGetCurrentWeather, &GetCurrentWeatherParams{}, handleGetCurrentWeather)

	// Register weather forecast operation
	a.RegisterOperation(operationIDGetWeatherForecast, &GetWeatherForecastParams{}, handleGetWeatherForecast)

	// Register one call weather data operation
	a.RegisterOperation(operationIDGetOneCallWeather, &GetOneCallWeatherParams{}, handleGetOneCallWeather)

	// Register air pollution data operation
	a.RegisterOperation(operationIDGetAirPollution, &GetAirPollutionParams{}, handleGetAirPollution)

	// Register geocoding operation
	a.RegisterOperation(operationIDGetGeocoding, &GetGeocodingParams{}, handleGetGeocoding)
}

// handleGetCurrentWeather handles current weather query
func handleGetCurrentWeather(ctx context.Context, params interface{}) (map[string]interface{}, error) {
	...
	// 参数校验
	if weatherParams.Lat < -90 || weatherParams.Lat > 90 || weatherParams.Lon < -180 || weatherParams.Lon > 180 {
		return nil, fmt.Errorf("invalid coordinates: lat=%v, lon=%v", weatherParams.Lat, weatherParams.Lon)
	}
...
func handleGetWeatherForecast(ctx context.Context, params interface{}) (map[string]interface{}, error) {
...
func handleGetOneCallWeather(ctx context.Context, params interface{}) (map[string]interface{}, error) {
...
func handleGetAirPollution(ctx context.Context, params interface{}) (map[string]interface{}, error) {
...
func handleGetGeocoding(ctx context.Context, params interface{}) (map[string]interface{}, error) {

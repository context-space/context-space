...
// OperationDefaults holds the default settings for various Zoom operations.
type OperationDefaults struct {
}

// ZoomAdapter is an adapter for the Zoom API using OAuth2.
...
// NewZoomAdapter creates a new Zoom adapter.
func NewZoomAdapter(
...
func (a *ZoomAdapter) createOAuth2Config(redirectURL string, scopes []string) *oauth2.Config {
...
func (a *ZoomAdapter) ShouldRefreshToken(oldToken *oauth2.Token) bool {
...
func (a *ZoomAdapter) RefreshOAuthToken(ctx context.Context, oldToken *oauth2.Token) (*oauth2.Token, error) {
...
func (a *ZoomAdapter) GenerateOAuthURL(ctx context.Context,
...
func (a *ZoomAdapter) ExchangeCodeForTokens(ctx context.Context, code, redirectURL, codeVerifier string) (*oauth2.Token, error) {
...
func (a *ZoomAdapter) CheckMissingPermissions(operationIdentifier string, authorizedScopes []string) (bool, []string, error) {
...
func (a *ZoomAdapter) GetScopesFromPermissions(permissions []string) ([]string, error) {
...
func (a *ZoomAdapter) GetPermissionIdentifiersFromScopes(scopes []string) ([]string, error) {

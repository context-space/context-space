...
// AcquireLock provides a mock function with given fields: ctx, key, expiration
func (_m *MockCache) AcquireLock(ctx context.Context, key string, expiration time.Duration) (bool, error) {
...
// MockCache_AcquireLock_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AcquireLock'
type MockCache_AcquireLock_Call struct {
	*mock.Call
}
...
func (_e *MockCache_Expecter) AcquireLock(ctx interface{}, key interface{}, expiration interface{}) *MockCache_AcquireLock_Call {
	return &MockCache_AcquireLock_Call{Call: _e.mock.On("AcquireLock", ctx, key, expiration)}
}

func (_c *MockCache_AcquireLock_Call) Run(run func(ctx context.Context, key string, expiration time.Duration)) *MockCache_AcquireLock_Call {
...
func (_c *MockCache_AcquireLock_Call) Return(_a0 bool, _a1 error) *MockCache_AcquireLock_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCache_AcquireLock_Call) RunAndReturn(run func(context.Context, string, time.Duration) (bool, error)) *MockCache_AcquireLock_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockCache) ReleaseLock(ctx context.Context, key string) error {
	ret := _m.Called(ctx, key)
...
// MockCache_ReleaseLock_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReleaseLock'
type MockCache_ReleaseLock_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - key string
func (_e *MockCache_Expecter) ReleaseLock(ctx interface{}, key interface{}) *MockCache_ReleaseLock_Call {
	return &MockCache_ReleaseLock_Call{Call: _e.mock.On("ReleaseLock", ctx, key)}
}

func (_c *MockCache_ReleaseLock_Call) Run(run func(ctx context.Context, key string)) *MockCache_ReleaseLock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockCache_ReleaseLock_Call) Return(_a0 error) *MockCache_ReleaseLock_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCache_ReleaseLock_Call) RunAndReturn(run func(context.Context, string) error) *MockCache_ReleaseLock_Call {
	_c.Call.Return(run)
	return _c
}
